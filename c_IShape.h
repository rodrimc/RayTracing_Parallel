...
public:
	...
	inline __device__ Point position() const
	{
		return _position;
	}
	inline __device__ Color color() const
	{
		return _color;
	}
	inline __device__ float reflection() const
	{
		return _reflection;
	}
	inline __device__ float specular() const
	{
		return _specularCoefficient;
	}
	inline __device__ float diffuse() const
	{
